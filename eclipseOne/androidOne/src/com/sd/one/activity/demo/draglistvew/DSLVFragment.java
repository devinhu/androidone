...
public class DSLVFragment extends ListFragment {
    ...
    protected int getLayout() {
        ...
        return R.layout.demo_drag_fragment_main;
    }
    ...
    protected int getItemLayout() {
    	...
    	if (removeMode == DragSortController.CLICK_REMOVE) {
            return R.layout.demo_drag_list_item_click_remove;
        } else {
            return R.layout.demo_drag_list_item_handle_left;
        }
    }
    ...
    public static void addHeader(Activity activity, DragSortListView dslv) {
        ...
        TextView header = (TextView) inflater.inflate(R.layout.demo_drag_header_footer, null);
    ...
    public static void addFooter(Activity activity, DragSortListView dslv) {
        ...
        TextView footer = (TextView) inflater.inflate(R.layout.demo_drag_header_footer, null);
