...
public class RequestParams1 {
    ...
    public RequestParams1(Map<String, String> source) {
        init();
        if (source != null) {
	...
	public RequestParams1(final String key, final String value) {
    ...
    public RequestParams1(Object... keysAndValues) {
        init();
