...
public class DrawerMenuActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_drawer_menu_layout);
        ...
        mDrawerList.setAdapter(new ArrayAdapter<String>(this, R.layout.demo_drawer_list_item, menuArray));
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.drawable.drawer_menu, R.string.app_name, R.string.app_name){
